...
public interface IIngredientVisibility {
	...
	interface IListener {
		...
		/**
		 * Called when many ingredients are made visible or invisible.
		 * @since 15.3.0
		 */
		default <V> void onIngredientVisibilityChanged(Collection<ITypedIngredient<V>> ingredients, boolean visible) {
